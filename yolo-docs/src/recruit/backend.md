...
![](https://uestc.feishu.cn/space/api/box/stream/download/asynccode/?code=YWMyYzc5ZmU1NWIwMzUyNmM1NmFhZjg0YTJjMzIxN2JfaXZlcGl5ajZYQ3JNeTBkaDN4T3pzMUtpcWJYUVg3REdfVG9rZW46TGE4TWI5YTEzb1QyTDN4Z09XbmN1M094bnBmXzE3MjU5NTEzNzk6MTcyNTk1NDk3OV9WNA)
...
![](https://uestc.feishu.cn/space/api/box/stream/download/asynccode/?code=NDQ4ZGJjMzNlZWNmOTJhZTMwZDlmNWM3NDg0Yzc5OTNfMkNkQ0hoSHE5UHpxODFUS3lqb1pHd3FPc003VDd0VnJfVG9rZW46RlByOWJhVmlub29SSFh4YjZSVmNFQUlFbkZlXzE3MjU5NTEzNzk6MTcyNTk1NDk3OV9WNA)![](https://uestc.feishu.cn/space/api/box/stream/download/asynccode/?code=OGViNTBmNWExYWI3MTQwOWJkOGJlNzhlNGIwMGY2YzdfNEROMlZtY0U3ZmxncmVjUVNpQkIyZUtBOXVOMUJVS29fVG9rZW46VGJzZWJGNGY5bzROOU54d25oa2MxQUpOblY5XzE3MjU5NTEzNzk6MTcyNTk1NDk3OV9WNA)

Java是一门[面向对象](https://baike.baidu.com/item/%E9%9D%A2%E5%90%91%E5%AF%B9%E8%B1%A1/0?fromModule=lemma_inlink)的编程语言，不仅吸收了[C++](https://baike.baidu.com/item/C++/0?fromModule=lemma_inlink)语言的各种优点，还摒弃了C++里难以理解的多继承、[指针](https://baike.baidu.com/item/%E6%8C%87%E9%92%88/2878304?fromModule=lemma_inlink)等概念，因此Java语言具有功能强大和简单易用两个特征。Java语言作为静态面向对象编程语言的代表，极好地实现了面向对象理论，允许程序员以优雅的思维方式进行复杂的编程
...
招新题完成数量不设指标，只要我们能从中看出你的学习能力、学习态度，你就有可能被选中,加入~~光荣的进化~~YOLO工作室！
...
> _Java是一种广泛使用的计算机编程语言，拥有跨平台、面向对象、泛型编程的特性，广泛应用于企业级Web应用开发和移动应用开发。_

而Java后端相信大家都有所耳闻，我们现在所看见的网站背后就是后端所实现的。在学习后端之前，我们肯定得先进行Java的学习。著名的五星上将麦克阿瑟曾说：从现在开始学Java，然后~~狠狠地赚他一笔！~~
...
相信你现在对Java有了一个初步地认识。现在我们要开始正式学习它了。
...
![[Pasted image 20240910145719.png]]
...
但是运动员和教练都需要吃饭，都需要睡觉，还有都需要学习吧，人都需要吃饭和睡觉，但是不是每个人都在学习，所以如果把学习放在people类中，是不是不够恰当，那么该如何实现呢？那么在之后我又发现一个只有运动员和教练才会有的行为，我怎么样更快的，更方便地让这个这两个类增加呢？
...
![](https://uestc.feishu.cn/space/api/box/stream/download/asynccode/?code=MjJkMzNmNzJjNTljOGMzZmMyY2ViMzRjMDBkOGE1NTNfQzZtclQxYTlBazcyeFFRTDZsajl3bWRMZ0ZtQXc0QkhfVG9rZW46VmNCNmJ6OWZHb0Q5Mkp4SkdqeWM4Zm9sblVjXzE3MjU5NTEzNzk6MTcyNTk1NDk3OV9WNA)
...
- 搭建MySQL环境
    ...
    - [https://www.bilibili.com/video/BV1jcabemEr7/?spm_id_from=333.337.search-card.all.click&vd_source=5a57db72ad9f15166dafe983742b0fad](https://www.bilibili.com/video/BV1jcabemEr7/?spm_id_from=333.337.search-card.all.click&vd_source=5a57db72ad9f15166dafe983742b0fad)
...
![](https://uestc.feishu.cn/space/api/box/stream/download/asynccode/?code=ZDVkOTg1NGY1NzZkOGQ0YmU2Nzg3YTY3NWZkZmE1YmZfeTRoYlRTbGZ2TUl2Q285akNPYVZ0TEZIcXJBaHZOUk9fVG9rZW46VFBQcWJCOVpDbzNWWEd4UllGZ2M1d2ExbmJmXzE3MjU5NTEzNzk6MTcyNTk1NDk3OV9WNA)
...
_"套接字（Socket）是一个可能有点晦涩的翻译。它直译为“插座”。它的直译也许会帮助你更好地理解他。就像你藏起来的暗恋，也许直球会让TA更懂你"_
...
|book_id|int||外键，引用是book表中的id<br><br>删除和更新时都设置为restict|
